...
export default function ViewReviewsScreen() {
  const [reviews] = useState<Review[]>([
    {
      ...
      rating: 3,
      comment: 'Great property! Very clean and well maintained. The location is perfect and the amenities are excellent.',
      date: '2025-09-01',
      helpful: 12,
      unhelpful: 2,
    ...
    },
    {
      ...
      userAvatar: 'https://ui-avatars.com/api/?name=John+Doe',
      rating: 5,
      comment: 'Nindot kaayo nga property! Limpyo gyud kaayo ug maayo pagkamentinar. Ang lokasyon perpekto, ug ang mga amenities nindot kaayo.',
      date: '2025-08-04',
      helpful: 652,
      unhelpful: 15,
      ...
      userAvatar: 'https://ui-avatars.com/api/?name=John+Doe',
      rating: 4,
      comment: 'Ang ganda ng property! Talagang sobrang linis at inaalagaan. Hindi matatawaran ang lokasyon, at pang-best talaga ang mga kagamitan at pasilidad.',
      date: '2025-05-21',
      helpful: 18,
      unhelpful: 0,
  ...
  const renderReview = ({ item }: { item: Review }) => (
    <View className="bg-white p-4 mb-4 rounded-xl shadow-sm">
      ...
      <Text className="text-gray-700 my-3 leading-6">
        {item.comment}
      </Text>
